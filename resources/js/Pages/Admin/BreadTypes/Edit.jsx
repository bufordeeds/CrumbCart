...
export default function BreadTypesEdit({ breadType }) {
    const { data, setData, patch, processing, errors, setError } = useForm({
        name: breadType.name,
        description: breadType.description,
        price: breadType.price,
        image: null,
        is_active: breadType.is_active,
        _method: "PATCH",
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        patch(route("admin.bread-types.update", breadType.id), {
            forceFormData: true,
        });
    };
    ...
    return (
        ...
        >
            <Head title={`Edit ${breadType.name}`} />

            <div className="py-8">
                <Container>
                    <Card>
                        <Card.Header>
                            <Card.Title>Edit Bread Type</Card.Title>
                        </Card.Header>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-gray-500">
                                            Upload a new image of the bread (max
                                            2MB)
                                        </p>
                                        <InputError
